...
### 📫 Connect with Me  
- 📧 **Email:** abhisreekrishna742@gmail.com  
- 💼 **LinkedIn:** [devarayalu-anumanchi](https://www.linkedin.com/in/devarayalu-anumanchi/)  
...
[![REST API](https://img.shields.io/badge/REST%20API-FF6F00?style=flat&logo=swagger&logoColor=white)](https://restfulapi.net/)
...
[![Eclipse](https://img.shields.io/badge/Eclipse-2C2255?style=flat&logo=eclipse-ide&logoColor=white)](https://www.eclipse.org/ide/)  
...
- Architecting **cloud-native applications** with AWS (EC2, Lambda, Kubernetes)  
- Building **modern web applications** using React, Spring Boot, and microservices architecture  
- Exploring **Reinforcement Learning** for automation and real-world optimization use-cases  
...
- 🥇 Honored by **StreetCause (2021)** for impactful humanitarian contributions  

---

### 🤝 Let’s Connect!

💬 Ask me about **Full-Stack**, **AWS**, or **Serverless Architecture**  
👯 Open to collaborating on **Cloud**, **DevOps**, or **Web Projects**  
🌍 Willing to **relocate** and available to **start immediately**  
